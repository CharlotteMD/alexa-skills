...
const ErrorHandler = {
  ...
  handle(handlerInput, error) {
    ...
    return handlerInput.responseBuilder
      .speak('You can ask me the recipe for your favorite fudge, or, you can say exit...Now, what can I help you with?' )
      .reprompt('You can ask me the recipe for your favorite fudge, or, you can say exit...Now, what can I help you with?')
      .getResponse();
  },
};
...
const languageStrings = {
  en: {
    translation: {
      ...
      SKILL_NAME: 'Delicious Fudge',
      WELCOME_MESSAGE: 'Welcome to %s. You can ask a question like, what\'s the recipe for a %s? ... Now, what can I help you with?',
      WELCOME_REPROMPT: 'You can ask questions such as, what\'s the recipe for a %s, or, you can say exit...Now, what can I help you with?',
      ...
      RECIPE_REPEAT_MESSAGE: 'You can ask questions such as, what\'s the recipe for a %s, or, you can say exit...Now, what can I help you with?',
      RECIPE_NOT_FOUND_MESSAGE: 'I\'m sorry, I dont really know ',
